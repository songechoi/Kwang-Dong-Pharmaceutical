...
function fnBorder(){
  for(let cnt=1; cnt<=4; cnt++){
    $('.dev-con-art').prepend('<span></sapn>');
  }
  $('.dev-con-art span').css({
    position:'absolute',      
    background:'#ff0000',
  })
  for(let idx=0;idx<=$('.dev-con-art').length-1;idx++){
    $('.dev-con-art').eq(idx).children('span').eq(0).css({
      left:'0',
      top:'0',
      width:'0',
      // width:'100%',
    ...
    $('.dev-con-art').eq(idx).children('span').eq(1).css({
      right:'0',
      top:'0',      
      width:'5px',
      height:'0',
    ...
    $('.dev-con-art').eq(idx).children('span').eq(2).css({
      right:'0',
      bottom:'0',
      width:'0',
      // width:'100%',
    ...
    $('.dev-con-art').eq(idx).children('span').eq(3).css({
      left:'0',
      bottom:'0',
      width:'5px',
      height:'0',
